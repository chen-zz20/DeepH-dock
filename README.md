...
*DeepH-dock* also defines a unified data format for machine-learning materials science applications that can be efficiently adopted for machine-learning force field and deep-learning electronic structure applications. please refer to [our documentation](https://deeph-dock.readthedocs.io/en/latest/key_concepts.html) for more details.
